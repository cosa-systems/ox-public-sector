...
/**
 * {@link AdminStyleLoginIdentifier}
 *
 ...
 */
@NonNullByDefault
public class AdminStyleLoginIdentifier {
    ...
    public String toString() {
        return "AdminStyleLoginIdentifier [type=" + type + ", user=" + user + "]";
    }

    @Generated("SparkTools")
    private AdminStyleLoginIdentifier(Builder builder) {
    ...
    public static final class Builder {
        ...
        public AdminStyleLoginIdentifier build() {
            return new AdminStyleLoginIdentifier(this);
        }
    }
